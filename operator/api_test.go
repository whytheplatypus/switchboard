...
func TestLeasesExpire(t *testing.T) {
	r := &Router{}
	r.register("http://expiring.local", "http://10.0.0.4:8000", time.Millisecond)
	r.register("http://forever.local", "http://10.0.0.5:8001", 0)
...
func TestHeartbeatExtendsLease(t *testing.T) {
	r := &Router{}
	r.register("http://beating.local", "http://10.0.0.4:8000", 20*time.Millisecond)
